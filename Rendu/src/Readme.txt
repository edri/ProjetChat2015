La compilation nécessite un compilateur c++ ainsi qu'une installation de la bibliothèque OpenSSL et Qt en version 5 avec les modules supplémentaires gérant SQLite et les Websockets.
