...
enum class MessageType : quint32 {NEW_ACCOUNT, INFO_USER, MESSAGE, LOGIN, USER_JOIN, JOIN, LEAVE, DISCONNECT, CONNECTED, SERVER_ERROR, ROOM, USER_ID, DELETE_ROOM, LEAVE_ROOM};
